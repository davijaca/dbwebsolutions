        ...
        <div className="row">
          <div className="col-lg-4 valign md-mb50">
            <div className="sec-head mb-0">
              ...
              <h3 className="wow mb-20 color-font">Our Skills and Tools</h3>
              <p>
                We are familiar with the most modern technologies and languages, and we'll build each project with the best available tools for each need.
              </p>
            </div>
          </div>
